...
| `totalXp`           | Int           | Default 0              | Tổng điểm kinh nghiệm tích lũy                  |
| `level`             | Int           | Default 1              | Cấp độ người học hiện tại                       |
| `tier`              | String        | Default "BRONZE"       | Thứ hạng bậc học tập                            |
| `preferredLanguage` | String        | Default 'vi', Not Null | Ngôn ngữ giao diện ưu tiên (`'vi'` hoặc `'en'`) |
